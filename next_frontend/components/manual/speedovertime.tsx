    ...
    <Card className="relative">
      <CardContent className="pt-6 pb-16">
        ...
        <p className="mb-4">
          ...
          displaying a chart that represents the speed of detected
          classifications in the surveillance feed.
        </p>

        <p className="mb-4">
          This data is collected every <strong>3 seconds</strong> to track
          changes in speed over time.
        </p>

        <ul className="list-disc pl-5 mb-4">
          <li>
            The <strong>Y-axis</strong> represents the average speed of each
            classification.
          </li>
          <li>
